...
export const MARKETPLACE_LISTINGS: MarketplaceListing[] = [
  {
    ...
    sellerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=priya&backgroundColor=ffd5dc',
    sellerRating: 4.9,
    category: 'course',
  ...
  },
  {
    ...
    sellerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ananya&backgroundColor=d1f7c4',
    sellerRating: 4.8,
    category: 'course',
  ...
  },
  {
    ...
    sellerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=meera&backgroundColor=ffdfbf',
    sellerRating: 4.7,
    category: 'product',
  ...
  },
  {
    ...
    sellerAvatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=suresh&backgroundColor=e0e7ff',
    sellerRating: 4.6,
    category: 'service',
