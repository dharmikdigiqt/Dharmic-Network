  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto' }}>
      <motion.div variants={containerVariants} initial="hidden" animate="visible">
        ...
        {/* Banner + Avatar combined section */}
        <motion.div variants={itemVariants}>
          <Box style={{ position: 'relative', marginBottom: 56 }}>
            {/* Banner */}
            <Box
              style={{
                height: 200,
            ...
            {/* Avatar — positioned at the junction, outside overflow:hidden */}
            <Box
              style={{
                position: 'absolute',
                bottom: -50,
            ...
            {/* Edit/Share buttons — top right of banner */}
            <Box style={{ position: 'absolute', bottom: -50, right: 24 }}>
              <Group gap="sm">
            ...
            <Card
              ...
              style={{ border: '1px solid #e8ecf0', borderTop: 'none', paddingTop: 60 }}
            >
              <Stack gap="xs">
                <Group gap="sm">
