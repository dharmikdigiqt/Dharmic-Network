...
import { IconSearch, IconUsers, IconLock, IconCheck, IconPlus } from '@tabler/icons-react';
                    ...
                    <Group justify="space-between" align="flex-start">
                      ...
                      <Group gap={6}>
                        {community.isVerified && (
                          <Badge size="sm" color="teal" variant="light">Verified</Badge>
                        )}
                        {isJoined && (
                          <Badge size="sm" variant="filled" style={{ backgroundColor: community.color }}>
                            <IconCheck size={10} style={{ marginRight: 4 }} /> Joined
                          </Badge>
                        )}
                      </Group>
                    </Group>
